    ...
    return {
      ...
      tooltip: {
        ...
        formatter: (params: { value: [number, number] }[]) => {
          const [r, acc] = params[0].value;
          return `<div style="font-size:11px"><b>${r.toFixed(1)}× 压缩</b><br/>OCR 精度 ${acc.toFixed(1)}%</div>`;
        },
      },
      ...
      series: [
        {
          name: "DeepSeek-OCR",
          type: "line" as const,
          data: xs.map((r) => [r, +ocrAccuracy(r).toFixed(2)]),
          showSymbol: false,
          smooth: true,
          areaStyle: {
            color: {
